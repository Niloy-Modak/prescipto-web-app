      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <input
            ...
            className="w-full px-5 py-3 rounded-2xl bg-white/40 border border-white/60 focus:bg-white/80 focus:ring-2 focus:ring-primary/20 outline-none transition-all duration-300 placeholder:text-gray-400"
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            <input
              ...
              className="w-full px-5 py-3 pr-14 rounded-2xl bg-white/40 border border-white/60 focus:bg-white/80 focus:ring-2 focus:ring-primary/20 outline-none transition-all duration-300 placeholder:text-gray-400"
